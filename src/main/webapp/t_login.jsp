    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group input-group input-group-lg">
                <p><a class="btn btn-lg btn-info" href="t_register.jsp" role="button">现在注册</a></p>
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group input-group input-group-lg">
...
<div class="jumbotron">
    <form method="post" action="t_login" class="form-signin" style="margin-left: 40%; margin-top: 10%;">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-lg-4 input-group input-group-lg">
                ...
                <input type="text" id="username" class="form-control"
                       placeholder="用户名" required autofocus name="teacherName"/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-lg-4 input-group input-group-lg">
                ...
                <input type="password" id="password" class="form-control "
                       placeholder="密码" required name="teacherPassword"/>
            </div>
        </div>
